...
const features = [
  ...
  },
  {
    ...
    description:
      "En el mercado de servicios náuticos en el Mediterráneo, Menorca Yacht Brokers se está destacando como una empresa pionera con una combinación única de <strong>Experiencia local, alcance global</strong>. Esta innovadora compañía menorquina ha logrado establecer una presencia significativa en el sector.",
      ...
      <div className="container mx-auto px-4">
        {features.map((feature, index) => (
          <motion.div
            ...
            } items-center justify-center gap-12 mb-20 last:mb-0`}
          >
            <div className="flex lg:w-1/3 justify-center">
              <div className="flex w-[400px] relative h-[300px] rounded-xl overflow-hidden shadow-lg">
                <Image
                  src={feature.image}
            ...
            <div className="w-full lg:w-1/2">
              <h2 className="text-3xl md:text-4xl font-montserrat font-medium text-primary mb-6">
                {feature.title}
              </h2>
