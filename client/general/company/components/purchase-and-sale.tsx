  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="bg-primary/10 p-8 rounded-xl border-2 border-primary/20">
            ...
            <p className="text-gray-700 mb-6">
              En Menorca Brokers, nos aseguramos de que cada transacción de
              yates se realice bajo los más altos estándares de la industria.
              Para garantizar transparencia, seguridad y confianza, utilizamos
              los Contratos MYBA, una de las formas contractuales más
              reconocidas y aceptadas en el mundo del alquiler y la venta de
              yates.
            </p>
            <p className="text-gray-700">
              ...
              transacciones relacionadas con yates, como alquileres y ventas.
              Este contrato establece de manera clara los derechos y
              obligaciones tanto del propietario como del cliente, minimizando
              riesgos y posibles malentendidos.
            </p>
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-3xl font-montserrat text-primary mb-8 text-center">
        ...
        >
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
            ...
            <p className="text-gray-700 mb-6">
              ...
              paso del proceso, garantizando que tu contrato MYBA esté adaptado
              a tus necesidades específicas. Ya sea que busques alquilar o
              adquirir un yate, trabajamos para que disfrutes de una experiencia
              sin preocupaciones.
            </p>
            <p className="text-gray-700">
