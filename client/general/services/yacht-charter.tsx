...
export default function YachtCharter() {
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="container px-4 py-24 mx-auto max-w-8xl bg-gray-50">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
        ...
        >
          <h2 className="text-4xl font-montserrat text-primary">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-white p-8 rounded-lg border shadow-lg hover:shadow-lg transition-shadow"
            >
              <div className="flex items-center gap-4">
                <div className="bg-primary/10 p-3 rounded-full w-fit mb-6">
                  {service.icon}
                </div>
                <h3 className="text-xl font-montserrat text-black mb-4">
                  {service.title}
                </h3>
              </div>
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <div className="relative h-[300px] w-[600px] rounded-lg overflow-hidden justify-center items-center">
                <Image
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-3xl font-montserrat text-black">
              ...
              <div className="flex gap-4">
                <Button
                  unstyled
                  className="bg-primary hover:bg-primary/75 text-black font-normal text-sm md:text-base py-2 px-4 rounded"
                >
                  Ver Flota
                </Button>
                <Button
                  unstyled
                  className="border border-primary text-black hover:bg-primary hover:text-white font-normal text-sm md:text-base py-2 px-4 rounded"
                >
                  Explorar Rutas
                </Button>
              </div>
      ...
      <div className="container mx-auto px-4 py-20 max-w-8xl ">
        ...
        >
          <h2 className="text-4xl font-montserrat text-primary mb-4">
      ...
      <div className="relative py-20">
        ...
        >
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-montserrat text-primary mb-6">
            ...
            <Button
              ...
              href="/contact"
              unstyled
              className="bg-primary hover:bg-primary/75 text-black font-normal text-sm md:text-lg py-3 px-6 rounded"
            >
              Reserva Tu Charter
            </Button>
          </div>
