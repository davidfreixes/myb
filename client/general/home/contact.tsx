    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative h-[40vh] w-full">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center max-w-8xl mt-5">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-montserrat text-primary mb-4 text-center">
              Contacto
            </h1>
            <h2 className="text-2xl text-white max-w-2xl text-center">
      ...
      <div className="container mx-auto px-4 py-16 max-w-[1400px]">
        <div className="grid md:grid-cols-2 gap-12 ">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            className="flex flex-col bg-white p-8 rounded-lg shadow-lg border"
          >
          ...
          >
            ...
            <div className="flex justify-between mt-8">
              ...
              <Button
                ...
                className="ml-auto bg-primary hover:bg-primary/90 text-white py-2 px-4 rounded"
              >
