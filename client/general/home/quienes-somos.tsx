        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center max-w-8xl">
          ...
          >
            <div className="space-y-3 sm:space-y-4">
              <h1 className="font-montserrat text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium tracking-tight text-primary mb-4">
                Quiénes Somos | Tu Equipo de Confianza en Menorca Brokers
              </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="font-montserrat text-3xl md:text-4xl text-primary">
